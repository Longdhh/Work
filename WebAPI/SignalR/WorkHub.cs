...
namespace WebAPI.SignalR
{
    ...
    public class WorkHub : Hub
    {
        ...
        public static void PushToAllUsers(AnnouncementViewModel message, WorkHub hub)
        {
        ...
        public static void PushToUser(string who, AnnouncementViewModel message, WorkHub hub)
        {
            IHubConnectionContext<dynamic> clients = GetClients(hub);
        ...
        /// <param name="who"></param>
        /// <param name="message"></param>
        public static void PushToUsers(string[] whos, AnnouncementViewModel message, WorkHub hub)
        {
            IHubConnectionContext<dynamic> clients = GetClients(hub);
        ...
        private static IHubConnectionContext<dynamic> GetClients(WorkHub teduShopHub)
        {
            if (teduShopHub == null)
                return GlobalHost.ConnectionManager.GetHubContext<WorkHub>().Clients;
            else
